...
//     ^^^^^ reference @types/react 19.2.15 `index.d.ts`/React/
//                ^^^^^^^ reference @types/react 19.2.15 `index.d.ts`/
...
//          ^^^^^ reference @types/react 19.2.15 `index.d.ts`/React/
//                ^^^^^^^^^ reference @types/react 19.2.15 `index.d.ts`/React/ReactNode#
}

export const LoaderInput: React.FunctionComponent<Props> = ({
//           ^^^^^^^^^^^ definition react-example 1.0.0 src/`LoaderInput.tsx`/LoaderInput.
//                        ^^^^^ reference @types/react 19.2.15 `index.d.ts`/React/
//                              ^^^^^^^^^^^^^^^^^ reference @types/react 19.2.15 `index.d.ts`/React/FunctionComponent#
...
//^^^^^^^^ reference react-example 1.0.0 src/`LoaderInput.tsx`/Props#children.
  ...
  <div className="hello">
// ^^^ reference @types/react 19.2.15 `index.d.ts`/React/JSX/IntrinsicElements#div.
//     ^^^^^^^^^ reference @types/react 19.2.15 `index.d.ts`/React/HTMLAttributes#className.
    {children}
//   ^^^^^^^^ reference local 3
    {loading && <p>spinner</p>}
//   ^^^^^^^ reference local 2
//               ^ reference @types/react 19.2.15 `index.d.ts`/React/JSX/IntrinsicElements#p.
//                          ^ reference @types/react 19.2.15 `index.d.ts`/React/JSX/IntrinsicElements#p.
  </div>
//  ^^^ reference @types/react 19.2.15 `index.d.ts`/React/JSX/IntrinsicElements#div.
)
...
//                    ^^^^^^^ reference react-example 1.0.0 src/`LoaderInput.tsx`/Props#loading.
//                                   ^^^ reference @types/react 19.2.15 `index.d.ts`/React/Attributes#key.
//                                             ^^^^^^^^ reference react-example 1.0.0 src/`LoaderInput.tsx`/Props#children.
//                                                       ^^^^^ reference local 4
//                                                             ^^^^^^^^ reference react-example 1.0.0 src/`LoaderInput.tsx`/Props#children.
}
